...
//				System.out.println("finished truss" + k);
	...
	public void read_GraphEdgelist(String fileName) throws IOException {
		System.out.println("MyGraph.java:166: Reading graph from file: " + fileName);
		g = new HashMap<Integer, HashMap<Integer, MyEdge>>();
	...
	protected int processLine(String aLine) {
		// System.out.println("MyGraph.java:193: processing line: " + aLine);
		StringTokenizer st;
		int id1, id2;
		...
		if (id1 == id2)
			return 0;
		// System.out.println("MyGraph.java:201: adding edge: " + id1 + " " + id2);
